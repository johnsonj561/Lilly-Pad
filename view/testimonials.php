    ...
    "<p class='article-body'>$article</p>
      ...
      <h3>Contribute to The Lilly Pad Website</h3>
        <a href='upload-article.php'>
          <button class='btn btn-primary'><span class='glyphicon glyphicon-upload'></span>Upload Testimonial</button>
        </a>
      </div></div>";
}
?>
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="The Lilly Pad West Palm Beach - View our inspirational testimonials and share with your friends">
    <meta name="author" content="The Lilly Pad">
    <meta name="ROBOTS" content="INDEX, FOLLOW">
    <link rel="icon" type="image/x-icon" href="../img/lily-pad-favicon-32x32.png" />
    <title>The Lilly Pad | Testimonials</title>
